 ...
 *
 */
public class DonationScheduleRares {

    /**
     * Default constructor
     */
    public DonationScheduleRares() {
    }

    public DonationScheduleRares(Integer idDS, Integer idDC, Timestamp donationDateTime, Integer availableSpots) {
        this.idDS = idDS;
        this.idDC = idDC;
